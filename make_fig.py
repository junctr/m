...
plt.plot(t_data, e_all_c[6],color="gray",label="conventional")
plt.plot(t_data, e_all_p[6],color="k",label="proposed")
...
# plt.xlim(40,100)
# plt.ylim(0.00175,0.0045)
# plt.ylim(0.000015,0.00013)
# plt.ylim(0,0.0045)
